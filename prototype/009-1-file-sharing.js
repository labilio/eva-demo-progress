(function(root){
  ...
  function bootstrap(membership){
    const key='eva:file-store:v7';let saved,previewDemoInitialized=false,externalLinksDemoV1=false;
    ...
    const persistRecords=records=>{try{root.localStorage.setItem(key,JSON.stringify({schema:7,records,externalLinksDemoV1:true}));}catch{}};
