...
window.__EVA_FILE_PREVIEW_FIXTURES = Object.assign(window.__EVA_FILE_PREVIEW_FIXTURES || {}, {
  'A-2409临时放行评审纪要.docx': {
    pages: [
      {kicker:'供应商质量评审',title:'A-2409 临时放行评审纪要',subtitle:'会议日期：2026-09-07 · 版本 V1.0',paragraphs:['针对 A-2409 批次来料尺寸偏差，质量、采购与生产团队完成联合评审。当前偏差不影响装配安全边界，但必须执行加严抽检。'],sections:[{title:'一、评审结论',text:'同意对 480 件在制物料实施一次性临时放行，有效期截至 9 月 12 日。后续批次不得沿用本结论。'},{title:'二、执行条件',text:'上线前完成 100% 外观检查与关键尺寸复测；异常件单独隔离，并由 SQE 每日汇总复核结果。'}]},
      {kicker:'会议纪要 · 第 2 页',title:'责任人与跟进计划',subtitle:'所有事项须在关闭前留存验证记录',paragraphs:['供应商需在两个工作日内提交 8D 初版，采购负责同步后续交付节奏，生产计划根据复测结果滚动调整。'],sections:[{title:'三、行动项',text:'林晓：完成复测清单；周远：确认补货节点；王宜林：组织 9 月 10 日关闭评审。'},{title:'四、签署',text:'质量负责人、采购负责人、生产负责人已完成会签。'}]}
    ]
  },
  'EVA-分享权限验收矩阵.xlsx': {
    sheets: [
