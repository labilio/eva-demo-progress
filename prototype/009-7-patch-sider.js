...
`;
        ...
        var nativePageComponent = 'EvaContactsPage=()=>window.EvaContactsUI.render({React:reactExports,Button,Input:ForwardInput,Modal,SearchIcon:Search$1,CloseIcon:X,store:evaMembers().store,ui:evaMembers().ui}),EvaNativePage=({pageId:rt})=>{const ct=reactExports.useRef(null);reactExports.useEffect(()=>{const ut=ct.current;return window.__evaNativePages?.mount(rt,ut),()=>window.__evaNativePages?.unmount(rt,ut)},[rt]);return React.createElement("div",{ref:ct,id:"eva-native-page-"+rt,className:"eva-native-page-host","data-eva-native-page":rt})},';
