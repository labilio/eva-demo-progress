...
EvaAiCollaborationRing=createLucideIcon("circle",[["circle",{cx:"12",cy:"12",r:"10",key:"ai-collaboration-ring"}]]),EvaMyAiCollaborationIcon=()=>React.createElement("span",{className:"eva-my-ai-collaboration-icon",role:"img","aria-label":"三个 AI 协作"},React.createElement(EvaAiCollaborationRing,{className:"eva-my-ai-collaboration-icon__ring",size:14,strokeWidth:1.5}),React.createElement("span",{className:"eva-my-ai-collaboration-icon__label eva-my-ai-collaboration-icon__label--top","aria-hidden":"true"},"AI"),React.createElement("span",{className:"eva-my-ai-collaboration-icon__label eva-my-ai-collaboration-icon__label--left","aria-hidden":"true"},"AI"),React.createElement("span",{className:"eva-my-ai-collaboration-icon__label eva-my-ai-collaboration-icon__label--right","aria-hidden":"true"},"AI")),
