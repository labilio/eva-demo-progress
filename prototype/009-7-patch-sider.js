(function (root) {
  ...
  root.__evaPatch('sidebar', function (source) {
         ...
         * 260 是 GDS 标准外壳的侧栏宽（047 的 --eva-sidebar-w），也是 vendor 自己的
         * DEFAULT_SIDER_WIDTH 原值；之前改成 248 会让 940 工作区变成 952，
         * 776 主列的左右内缩就不再是规范的 82/82。折叠宽保持 84。 */
        var sidebarWidthReplacements = [
          [
            'DEFAULT_SIDER_WIDTH=260,DESKTOP_COLLAPSED_WIDTH=0,SIDER_MIN_WIDTH=200',
            'DEFAULT_SIDER_WIDTH=260,DESKTOP_COLLAPSED_WIDTH=84,SIDER_MIN_WIDTH=200'
          ],
          [
...
EvaPersonalChevronIcon=createLucideIcon("chevron-right",[["path",{d:"m9 18 6-6-6-6",key:"personal-chevron-right"}]]),
EvaPersonalMoreIcon=createLucideIcon("ellipsis",[["circle",{cx:"12",cy:"12",r:"1",key:"personal-ellipsis-middle"}],["circle",{cx:"19",cy:"12",r:"1",key:"personal-ellipsis-end"}],["circle",{cx:"5",cy:"12",r:"1",key:"personal-ellipsis-start"}]]),
EVA_PERSONAL_ASSISTANT_TASKS=Object.freeze({"assistant-general":[["UI设计师发展前景的PPT","3 小时"],["整理本周会议结论","7 小时"],["帮我改写产品说明","1 天"]],"assistant-rd":[["Eva 前端联调排期","1 分钟"],["接口回归清单","2 天"]]}),
EvaPersonalAssistantFolder=({assistant:rt,selected:ct,onSelect:ut,onNewChat:pt})=>{const[mt,gt]=reactExports.useState(!1),vt=EVA_PERSONAL_ASSISTANT_TASKS[rt.id]||[];return React.createElement("section",{className:classNames("eva-assistant-folder","eva-personal-assistant-folder",mt&&"is-collapsed"),"data-eva-assistant-id":rt.id,"data-eva-assistant-name":rt.name},React.createElement("div",{className:"eva-personal-assistant-folder__row"},React.createElement("button",{type:"button",className:"eva-assistant-folder__button","aria-expanded":String(!mt),onClick:()=>gt(!mt)},React.createElement("span",{className:"eva-assistant-folder__icon","aria-hidden":"true"},React.createElement(Brain$8,{size:18,strokeWidth:1.5})),React.createElement("span",{className:"eva-assistant-folder__name"},rt.name),React.createElement("span",{className:"eva-assistant-folder__chevron","aria-hidden":"true"},React.createElement(EvaPersonalChevronIcon,{size:12,strokeWidth:1.5}))),React.createElement("span",{className:"eva-personal-assistant-folder__actions"},React.createElement("button",{type:"button","aria-label":"编辑"+rt.name,"data-eva-edit-assistant":"true"},React.createElement(EvaPersonalMoreIcon,{size:16,strokeWidth:1.5})),React.createElement("button",{type:"button",className:"eva-personal-assistant-folder__new-chat","aria-label":"新建对话",onClick:pt},React.createElement(EvaPersonalPlusIcon,{size:16,strokeWidth:1.5})))),React.createElement("div",{className:"eva-assistant-folder__conversations"},vt.map(bt=>React.createElement("button",{key:bt[0],type:"button",className:classNames("eva-assistant-conversation",ct===bt[0]&&"is-selected"),onClick:()=>ut(bt[0])},React.createElement("span",{className:"eva-assistant-conversation__title"},bt[0]),React.createElement("time",{className:"eva-assistant-conversation__time"},bt[1])))))},
EvaPersonalWorkspacePanel=({historyProps:rt,navigate:ct})=>{const[ut,pt]=reactExports.useState("tasks"),[mt,gt]=reactExports.useState(()=>(window.__EVA_PERSONAL_ASSISTANTS||[]).slice()),[vt,bt]=reactExports.useState("UI设计师发展前景的PPT");reactExports.useEffect(()=>{const wt=()=>gt((window.__EVA_PERSONAL_ASSISTANTS||[]).slice());return window.addEventListener("eva:personal-assistants-change",wt),()=>window.removeEventListener("eva:personal-assistants-change",wt)},[]);const yt=()=>ct("/guid");return React.createElement("div",{className:"eva-personal-sider-panel"},React.createElement("div",{className:"eva-personal-sider-panel__tabs",role:"tablist","aria-label":"个人工作区","data-active":ut},React.createElement("button",{type:"button",role:"tab",className:"eva-personal-sider-panel__tab","aria-selected":ut==="tasks","data-eva-personal-sider-tab":"tasks",onClick:()=>pt("tasks")},"任务"),React.createElement("button",{type:"button",role:"tab",className:"eva-personal-sider-panel__tab","aria-selected":ut==="conversations","data-eva-personal-sider-tab":"conversations",onClick:()=>pt("conversations")},"对话")),ut==="tasks"?React.createElement("div",{className:"eva-personal-sider-panel__body"},React.createElement("div",{className:"eva-assistant-tree"},React.createElement("div",{className:"eva-my-ai-sidebar-actions eva-personal-sidebar-actions"},React.createElement("button",{type:"button",className:"eva-assistant-tree__create eva-my-ai-sidebar-actions__create-assistant","aria-label":"创建助理"},React.createElement(EvaPersonalPlusIcon,{size:16,strokeWidth:1.5}),"创建助理"),React.createElement("button",{type:"button",className:"eva-assistant-tree__new-chat eva-my-ai-sidebar-actions__new-session","aria-label":"新建对话",onClick:yt},"新建对话")),mt.map(wt=>React.createElement(EvaPersonalAssistantFolder,{key:wt.id,assistant:wt,selected:vt,onSelect:bt,onNewChat:yt})))):React.createElement("div",{className:classNames("eva-personal-sider-panel__history",siderStyles.scrollArea)},React.createElement(reactExports.Suspense,{fallback:React.createElement("div",{className:"min-h-200px"})},React.createElement(WorkspaceGroupedHistory$1,{...rt}))))},
EvaPersonalEntry=rt=>React.createElement("div",{className:classNames("eva-personal-entry",rt.collapsed&&"is-collapsed",rt.isActive&&"is-selected"),"data-eva-my-assistant-identity":"true","aria-current":rt.isActive?"page":void 0},React.createElement("button",{type:"button",className:"eva-personal-entry__main",onClick:rt.onClick,"aria-label":"Eva 同学",title:"Eva 同学"},React.createElement("span",{className:"eva-personal-entry__logo"},React.createElement("img",{src:window.__EVA_COLLEAGUE_PORTRAIT,alt:""})),React.createElement("span",{className:"eva-personal-entry__label"},"Eva 同学")),React.createElement("span",{className:"eva-personal-entry__plus","aria-hidden":"true"},React.createElement(EvaPersonalPlusIcon,{size:16,strokeWidth:1.8}))),
