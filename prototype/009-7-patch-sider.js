...
EvaAiCollaborationRing=createLucideIcon("circle",[["circle",{cx:"12",cy:"12",r:"10",key:"ai-collaboration-ring"}]]),EvaMyAiCollaborationIcon=()=>React.createElement("span",{className:"eva-my-ai-collaboration-icon",role:"img","aria-label":"多个 AI 协作"},React.createElement(EvaAiCollaborationRing,{className:"eva-my-ai-collaboration-icon__ring",size:14,strokeWidth:1.5}),React.createElement(Bot,{className:"eva-my-ai-collaboration-icon__bot eva-my-ai-collaboration-icon__bot--top",size:7,strokeWidth:1.8}),React.createElement(Bot,{className:"eva-my-ai-collaboration-icon__bot eva-my-ai-collaboration-icon__bot--left",size:7,strokeWidth:1.8}),React.createElement(Bot,{className:"eva-my-ai-collaboration-icon__bot eva-my-ai-collaboration-icon__bot--right",size:7,strokeWidth:1.8})),
