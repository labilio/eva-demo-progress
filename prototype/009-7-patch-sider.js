...
EvaMyAiCollaborationIcon=()=>{const rt=window.EvaAITeam,ct=window.EvaDigitalEmployeesStore;reactExports.useSyncExternalStore(rt.subscribe,rt.getSnapshot,rt.getSnapshot);reactExports.useSyncExternalStore(ct.subscribe,ct.getSnapshot,ct.getSnapshot);const ut=rt.hasUnread()||ct.hasUnread();return React.createElement("span",{className:"eva-my-ai-collaboration-icon-wrap"},React.createElement("img",{className:"eva-my-ai-collaboration-icon",src:"prototype/assets/my-ai-collaboration.svg",alt:""}),ut&&React.createElement("span",{className:"eva-my-ai-collaboration-icon__unread",role:"status","aria-label":"我的 Agent 有未读消息",title:"有未读消息"}))},
