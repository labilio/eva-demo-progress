(function (root) {
  ...
  root.__evaPatch('general', function (source) {
        ...
        var replacements = [
          ...
          [
            '},[pt,xt]);return React.createElement("div",{className:"collab-frame eva-channel-surface","data-eva-channel-surface":"project"}',
            '},[pt,xt]);reactExports.useEffect(()=>{const Ft=Qt=>{const Nt=Qt.detail||{};Nt.projectId===rt.id&&Nt.tab&&mt(Nt.tab)};return window.addEventListener("eva:open-project-view",Ft),()=>window.removeEventListener("eva:open-project-view",Ft)},[rt.id]);return React.createElement("div",{className:"collab-frame eva-channel-surface","data-eva-channel-surface":"project","data-eva-project-id":rt.id,"data-eva-project-tab":pt}'
          ],
          [
